...
const Navbar = () => {
  return (
    <div className="flex  items-center p-5 md:px-8 lg:px-20 space-x-4 border-b-2 border-neutral-200 lg:border-none">
      <div className="flex-grow lg:flex-grow-0 flex items-center space-x-3">
        ...
        />
        <div className=" hidden sm:flex space-x-[6px] md:px-5 md:h-8 lg:border-r-2 border-neutral-200">
